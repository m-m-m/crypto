 ...
 * @since 1.0.0
 */
public class Secp256k1<S extends SecuritySignatureEcBc> extends SecurityAccessEcBc<S> {
   ...
   */
  public Secp256k1(SecuritySignatureConfig<S> signatureConfig,
   ...
   */
  public Secp256k1(SecuritySignatureFactoryEcBc<S> signatureFactory, SecurityHashConfig hashConfig, SecurityRandomFactory randomFactory) {
   ...
   */
  public static Secp256k1<SecuritySignatureEcBcPlain> ofPlain(String hashAlgorithm) {
   ...
   * @return a {@link Secp256k1} instance for default signature.
   */
  public static Secp256k1<SecuritySignatureEcBcPlain> ofPlain(SecurityHashConfig hashConfig) {
   ...
   */
  public static Secp256k1<SecuritySignatureEcBcWithRecoveryId> ofRecoveryId(String hashAlgorithm) {
   ...
   * @return a {@link Secp256k1} instance for bitcoin signature.
   */
  public static Secp256k1<SecuritySignatureEcBcWithRecoveryId> ofRecoveryId(SecurityHashConfig hashConfig) {
   ...
   */
  public static <S extends SecuritySignatureEcBc> Secp256k1<S> of(SecuritySignatureFactoryEcBc<S> signatureFactory,
