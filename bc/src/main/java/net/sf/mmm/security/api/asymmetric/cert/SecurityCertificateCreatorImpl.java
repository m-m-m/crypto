 ...
 * @since 1.0.0
 */
public class SecurityCertificateCreatorImpl extends AbstractSecurityAlgorithm implements SecurityCertificateCreator {
   ...
   */
  public SecurityCertificateCreatorImpl(SecurityCertificateConfig config) {
  ...
  @Override
  public Certificate generateCertificate(SecurityAsymmetricKeyPair<?, ?> keyPair, SecurityCertificateData certificateData) {
  ...
  @Override
  public SecurityCertificateData getCertificateData(Certificate certificate) {
