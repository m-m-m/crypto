 ...
 * @since 1.0.0
 */
public class Curve25519<S extends SecuritySignatureEcBc> extends SecurityAccessEcBc<S> {
  ...
  public static final SecurityEllipticCurveBc CURVE = new SecurityEllipticCurveBc(CURVE_NAME) {
    ...
    protected BigInteger determineCurveQ() {
      ...
      org.bouncycastle.math.ec.custom.djb.Curve25519 curve = (org.bouncycastle.math.ec.custom.djb.Curve25519) getEcParameters().getCurve();
      return curve.getQ();
    }
  };
   ...
   */
  public Curve25519(SecuritySignatureConfig<S> signatureConfig,
   ...
   */
  public Curve25519(SecuritySignatureFactoryEcBc<S> signatureFactory, SecurityHashConfig hashConfig, SecurityRandomFactory randomFactory) {
   ...
   */
  public static Curve25519<SecuritySignatureEcBcPlain> ofPlain(String hashAlgorithm) {
   ...
   * @return a {@link Curve25519} instance for plain signature.
   */
  public static Curve25519<SecuritySignatureEcBcPlain> ofPlain(SecurityHashConfig hashConfig) {
  ...
  /**
   * @param hashAlgorithm the {@link SecurityHashConfig#getAlgorithm() algorithm} for the hash used for signatures.
   * @return a {@link Curve25519} instance for signature with {@link SecuritySignatureEcBcWithRecoveryId#getRecoveryId()
   *         recovery ID}.
   */
  public static Curve25519<SecuritySignatureEcBcWithRecoveryId> ofRecoveryId(String hashAlgorithm) {
   ...
   *         recovery ID}.
   */
  public static Curve25519<SecuritySignatureEcBcWithRecoveryId> ofRecoveryId(SecurityHashConfig hashConfig) {
   ...
   */
  public static <S extends SecuritySignatureEcBc> Curve25519<S> of(SecuritySignatureFactoryEcBc<S> signatureFactory,
