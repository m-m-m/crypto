...
/**
 * {@link SecuritySignatureEcBc} with an extra byte for the {@link #getRecoveryId() recovery ID}. Allows to
...
public class SecuritySignatureEcBcWithRecoveryId extends SecuritySignatureEcBc implements SecuritySignatureWithPublicKeyRecovery {
   ...
   */
  protected SecuritySignatureEcBcWithRecoveryId(SecurityEllipticCurveBc curve, byte[] data, BigInteger r, BigInteger s,
      byte recoveryOffset) {
   ...
   * @param recoveryOffset the {@link #getRecoveryOffset() recovery offset}.
   */
  public SecuritySignatureEcBcWithRecoveryId(SecurityEllipticCurveBc curve, byte[] data, byte recoveryOffset) {
   ...
   */
  public static SecuritySignatureEcBcWithRecoveryId of(SecurityEllipticCurveBc curve, BigInteger r, BigInteger s, byte[] message,
    ...
    return new SecuritySignatureEcBcWithRecoveryId(curve, data, r, sCanonical, recoveryOffset);
  }
