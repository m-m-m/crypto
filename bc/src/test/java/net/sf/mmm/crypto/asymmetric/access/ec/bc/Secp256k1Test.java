...
public class Secp256k1Test extends AsymmetricAccessTest {
  ...
  public void testSecp256k1() {
    ...
    assertThat(secp256k1.getSignatureConfig().getHashConfig().getAlgorithm()).isEqualTo("SHA-256").isEqualTo(Sha256.ALGORITHM_SHA_256);
  ...
  public void testSecp256k1KeyPairFromBitcoin() {
    ...
    Secp256k1<SignatureEcBcWithRecoveryId> secp256k1 = Secp256k1.ofRecoveryId(new HashConfig(Sha256.ALGORITHM_SHA_256, 1));
    ...
    assertThat(BinaryType.formatHex(keyCreator.asData(privateKey, CryptoBinaryFormat.FORMAT_COMPACT))).isEqualTo(privateKeyHex);
    ...
    assertThat(BinaryType.formatHex(keyCreator.asData(publicKey, CryptoBinaryFormat.FORMAT_COMPACT))).isEqualTo(publicKeyHex);
    ...
    SignatureEcBcWithRecoveryId signature = secp256k1.getSignatureFactoryWithoutHash().newSigner(privateKey).sign(hash, false);
