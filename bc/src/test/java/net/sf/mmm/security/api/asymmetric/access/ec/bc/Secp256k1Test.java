...
public class Secp256k1Test extends SecurityAccessAsymmetricTest {
  ...
  /**
   * Test of {@link Secp256k1#ofRecoveryId(SecurityHashConfig)} with official examples from BitCoin.
   */
  @Test
  public void testSecp256k1KeyPairFromBitcoin() {

    Secp256k1<SecuritySignatureEcBcWithRecoveryId> secp256k1 = Secp256k1.ofRecoveryId(new SecurityHashConfig(Sha256.ALGORITHM_SHA_256, 1));
  ...
  /**
   * Advanced signature test of {@link Secp256k1#ofPlain(SecurityHashConfig)}.
   */
  @Test
  public void testSecp256k1Sign() {
    ...
    String privateKeyHex = "e9873d79c6d87dc0fb6a5778633389f4453213303da61f20bd67fc233aa33262";
    byte[] privateKeyBytes = BinaryType.parseHex(privateKeyHex);
    Secp256k1<SecuritySignatureEcBcPlain> secp256k1 = Secp256k1.ofPlain(new SecurityHashConfig(Sha256.ALGORITHM_SHA_256));
    SecurityAsymmetricKeyCreatorEcBc keyCreator = secp256k1.newKeyCreator();
    SecurityAsymmetricKeyPairEcBc keyPair = keyCreator.createKeyPair(privateKeyBytes);
