...
image:https://img.shields.io/maven-central/v/net.sf.mmm/mmm-crypto-bc.svg?label=Maven%20Central["Maven Central",link=https://search.maven.org/search?q=g:net.sf.mmm]
