 ...
 * @since 1.0.0
 */
public abstract interface SecurityCryptorFactory extends AbstractSecurityFactory, SecurityCryptorConstants {

  /** {@link #getType() Type} of this factory. */
  public static final String TYPE = "CryptorFactory";
