 ...
 * @since 1.0.0
 */
public abstract class AbstractSecurityAlgorithm implements SecurityAlgorithm {
   ...
   * @see #getAlgorithm()
   */
  protected static String getAlgorithm(SecurityAlgorithm[] algorithms) {

    StringBuilder buffer = new StringBuilder();
    for (SecurityAlgorithm algorithm : algorithms) {
      if (buffer.length() > 0) {
        buffer.append('+');
      }
