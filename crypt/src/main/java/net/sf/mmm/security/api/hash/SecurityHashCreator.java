 ...
 * @since 1.0.0
 */
public interface SecurityHashCreator extends SecurityChunker {
   ...
   * is to call this method once on a fresh instance of {@link SecurityHashCreator}, then write data to that stream and
   ...
   * {@link SecurityHashCreator} after the call of this method is therefore unspecified. Use this method only if you do
   * not care about the further state of this {@link SecurityHashCreator}. Otherwise use {@link #hash(boolean)} instead.
   *
   * @return the calculated hash of the current data.
   ...
   * @see java.security.MessageDigest#digest()
   *
   * @param reset - {@code true} if this {@link SecurityHashCreator} shall be {@link #reset() reset} after the hash
