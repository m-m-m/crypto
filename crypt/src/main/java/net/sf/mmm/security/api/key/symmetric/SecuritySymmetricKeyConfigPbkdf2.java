...
public class SecuritySymmetricKeyConfigPbkdf2 extends SecuritySymmetricKeyConfigPbe implements SecurityAlgorithmPbkdf2 {
  ...
  public static final SecuritySymmetricKeyConfigPbkdf2 PBKDF2_WITH_HMAC_SHA256 = new SecuritySymmetricKeyConfigPbkdf2(ALGORITHM_PBKDF2_WITH_HMAC_SHA256, 256);
   ...
   */
  public SecuritySymmetricKeyConfigPbkdf2(String algorithm, int keyLength, byte[] salt, int iterationCount) {

    super(algorithm, keyLength, iterationCount, salt);
  }
