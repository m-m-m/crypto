...
class SignatureAlgorithmTest extends Assertions {
  ...
  private void check(String hashAlgorithm, String signingAlgorithm, String expectedAlgorithm)
      throws NoSuchAlgorithmException {

    check(hashAlgorithm, signingAlgorithm, expectedAlgorithm, true);
  }

  private void check(String hashAlgorithm, String signingAlgorithm, String expectedAlgorithm, boolean jce)
      throws NoSuchAlgorithmException {
