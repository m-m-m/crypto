...
public abstract interface CryptoProcessor extends CryptoAlgorithm {
   ...
   * </tr>
   * <tr>
   * <td>{@link io.github.mmm.crypto.hash.HashCreator}</td>
   * <td><code>{@link io.github.mmm.crypto.hash.HashCreator#update(byte[]) update}(input);
   * return {@link io.github.mmm.crypto.hash.HashCreator#hash(boolean) hash}(true);</code></td>
   * </tr>
   * <tr>
   * <td>{@link io.github.mmm.crypto.crypt.Cryptor}</td>
   * <td><code>return {@link io.github.mmm.crypto.crypt.Cryptor#crypt(byte[], boolean) crypt}(input, true);</code></td>
   * </tr>
   * <tr>
   * <td>{@link io.github.mmm.crypto.asymmetric.sign.SignatureSigner}</td>
   * <td><code>{@link io.github.mmm.crypto.asymmetric.sign.SignatureSigner#update(byte[]) update}(input);
   * return {@link io.github.mmm.crypto.asymmetric.sign.SignatureSigner#signAfterUpdateRaw(boolean) signAfterUpdateRaw}(true);</code></td>
   * </tr>
   * <tr>
   * <td>{@link io.github.mmm.crypto.asymmetric.sign.SignatureVerifier}</td>
   ...
   * <tr>
   * <td>{@link io.github.mmm.crypto.hash.HashCreator}</td>
   * <td><code>{@link io.github.mmm.crypto.hash.HashCreator#update(byte[], int, int) update}(input, offset, length);
   * return {@link io.github.mmm.crypto.hash.HashCreator#hash(boolean)
   * hash}(true);</code></td>
   * </tr>
   * <tr>
   * <td>{@link io.github.mmm.crypto.crypt.Cryptor}</td>
   * <td><code>return {@link io.github.mmm.crypto.crypt.Cryptor#crypt(byte[], int, int, boolean) crypt}(input, offset, length, true);</code></td>
   * </tr>
   * <tr>
   * <td>{@link io.github.mmm.crypto.asymmetric.sign.SignatureSigner}</td>
   * <td><code>{@link io.github.mmm.crypto.asymmetric.sign.SignatureSigner#update(byte[], int, int) update}(input, offset, length);
   * return {@link io.github.mmm.crypto.asymmetric.sign.SignatureSigner#signAfterUpdate(boolean) signAfterUpdate}(true);</code></td>
   * </tr>
   * <tr>
   * <td>{@link io.github.mmm.crypto.asymmetric.sign.SignatureVerifier}</td>
   * <td><code>throw new {@link UnsupportedOperationException}();</code></td>
   ...
   * <td>{@link io.github.mmm.crypto.asymmetric.sign.SignatureSigner}</td>
   * <td><code>{@link io.github.mmm.crypto.asymmetric.sign.SignatureSigner#update(byte[], int, int) update}(input, offset, length);
   * return {@link io.github.mmm.crypto.asymmetric.sign.SignatureSigner#signAfterUpdate(boolean) signAfterUpdate}(complete);</code></td>
   * </tr>
   * <tr>
   * <td>{@link io.github.mmm.crypto.asymmetric.sign.SignatureVerifier}</td>
   * <td><code>throw new {@link UnsupportedOperationException}();</code></td>
   ...
   * {@link io.github.mmm.crypto.crypt.Cryptor} may <b>not</b> reusable. It is therefore preferable to always create a
