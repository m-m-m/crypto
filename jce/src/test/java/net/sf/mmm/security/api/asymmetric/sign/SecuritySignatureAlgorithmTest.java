...
public class SecuritySignatureAlgorithmTest extends Assertions {
  ...
  private void check(String hashAlgorithm, String signingAlgorithm, String expectedAlgorithm, boolean jce) throws NoSuchAlgorithmException {
    ...
    SecuritySignatureAlgorithm signatureAlgorithm = SecuritySignatureAlgorithm.of(hashAlgorithm, signingAlgorithm);
    ...
    SecuritySignatureAlgorithm signatureAlgorithm2;
    signatureAlgorithm2 = SecuritySignatureAlgorithm.of(expectedAlgorithm);
