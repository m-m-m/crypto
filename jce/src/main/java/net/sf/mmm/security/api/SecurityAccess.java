 ...
 * provided by this security library. All sub-classes and implementations of this class start with the prefix
 * {@link SecurityAccess} to support tab-completion (content assist). All implementations act as factory for according
 * security objects to create keys, encryptors/decryptors, signatures, hashes, or random.
 *
