...
/**
 * Implementation of {@link AbstractSecurityAsymmetricKeyPairFactory} for RSA in
 * {@link SecurityBinaryFormat#FORMAT_COMPACT compact format}.
 *
 * @since 1.0.0
 */
public class SecurityAsymmetricKeyPairFactoryRsaCompact
    extends AbstractSecurityAsymmetricKeyPairFactory<RSAPrivateKey, RSAPublicKey, SecurityAsymmetricKeyPairRsa> {
   ...
   * The constructor.
   */
  public SecurityAsymmetricKeyPairFactoryRsaCompact() {

    super(SecurityAsymmetricKeyPairRsa.getKeyFactory());
  }
   ...
   */
  public SecurityAsymmetricKeyPairFactoryRsaCompact(KeyFactory keyFactory) {
  ...
  public RSAPrivateKey createPrivateKey(byte[] data) {
    ...
    return SecurityAsymmetricKeyPairRsa.createPrivateKey(modulus, privateExponent);
  }
  ...
  public byte[] asData(RSAPublicKey publicKey) {
    ...
    boolean defaultPublicExponent = publicExponent.equals(SecurityAsymmetricKeyPairRsa.PUBLIC_EXPONENT);
  ...
  public RSAPublicKey createPublicKey(byte[] data) {
    ...
    return SecurityAsymmetricKeyPairRsa.createPublicKey(modulus);
  }

  @Override
  public byte[] asData(SecurityAsymmetricKeyPairRsa keyPair) {
  ...
  @Override
  public SecurityAsymmetricKeyPairRsa createKeyPair(byte[] data) {

    RSAPrivateKey privateKey = createPrivateKey(data);
    RSAPublicKey publicKey = SecurityAsymmetricKeyPairRsa.createPublicKey(privateKey.getModulus());
