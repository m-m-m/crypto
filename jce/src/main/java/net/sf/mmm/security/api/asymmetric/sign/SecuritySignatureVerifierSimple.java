...
/**
 * Extends {@link SecuritySignatureProcessor} with ability to {@link #verify(byte[], byte[]) verify} a message with a
 * given expected signature.
 *
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 */
public interface SecuritySignatureVerifierSimple extends SecuritySignatureProcessor {
