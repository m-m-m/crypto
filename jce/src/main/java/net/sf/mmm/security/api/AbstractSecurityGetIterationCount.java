 ...
 * @since 1.0.0
 */
public abstract interface AbstractSecurityGetIterationCount {

  /**
   * @return the iteration count representing the number of repetitive iterations of an
   *         {@link SecurityAlgorithm#getAlgorithm() algorithm} such as a hash function. A value of {@code 1} means that
