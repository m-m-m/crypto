...
public final class SecurityProvider {
   ...
   * @see net.sf.mmm.security.api.asymmetric.sign.SecuritySignatureAlgorithm
   */
   ...
   *        {@link net.sf.mmm.security.api.crypt.SecurityCipherTransformation#getTransformation() transformation}.
