 ...
 * @since 1.0.0
 */
public abstract class AbstractSecurityAsymmetricKeyPair<PR extends PrivateKey, PU extends PublicKey>
    implements SecurityAsymmetricKeyPair<PR, PU> {
   ...
   */
  public AbstractSecurityAsymmetricKeyPair(PR privateKey, PU publicKey) {
  ...
  public AbstractSecurityAsymmetricKeyPair(KeyPair keyPair) {
   ...
   * @param keyPair the {@link #getKeyPair() key pair}.
   */
  public AbstractSecurityAsymmetricKeyPair(PR privateKey, PU publicKey, KeyPair keyPair) {
