...
import net.sf.mmm.security.api.asymmetric.key.generic.SecurityAsymmetricKeyPairGeneric;
...
import net.sf.mmm.security.api.symmetric.key.SecuritySymmetricKeyGeneric;
...
public class SecurityKeyStoreImpl implements SecurityKeyStore {
   ...
   */
  public SecurityKeyStoreImpl(SecurityKeyStoreConfig config) {
  ...
  private void setKeyPairInternal(String alias, Key secureKey, String password, SecurityCertificatePath certificatePath) {
